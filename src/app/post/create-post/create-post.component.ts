...
export class CreatePostComponent implements OnInit {
  ...
  createPost()
  {
    this.postPayload.postName = this.createPostForm.get('postName')?.value;
     this.postPayload.description = this.createPostForm.get('url')?.value;
     this.postPayload.url = this.createPostForm.get('description')?.value;
     this.postPayload.subredditName = this.createPostForm.get('description')?.value;
